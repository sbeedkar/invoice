...
public class GenerateInvoice {
	...
	public static void main(String[] args) {
		...
		String pdfFilename = "invoicedocument";
	...
	private void createPDF(String pdfFilename) {
		...
		try {
			String path = "D:/invoicepdfs/invoicedocument5.pdf";
			docWriter = PdfWriter.getInstance(doc, new FileOutputStream(path));
			doc.addAuthor("SBeedkar");
			doc.addCreationDate();
			doc.addProducer();
			doc.addCreator("Silicus Tech.");
			doc.addTitle("Silicus Invoice");
	...
	private void generateLayout(Document doc, PdfContentByte cb) {
		System.out.println("inside generateLayout pdf");
		try {

			cb.setLineWidth(1f); // 0f single line 1f: bold line
			...
			createHeadings(cb, 422, 743, "Employee Number");
			...
			// add the images
			Image companyLogo = Image.getInstance("images/silicus.png");
	...
	private void generateHeader(Document doc, PdfContentByte cb) {
		...
		try {
			...
			createHeadings(cb, 482, 743, "ABC0001");// put emp id
	...
	private void generateDetail(Document doc, PdfContentByte cb, int index, int y) {
		System.out.println("inside generateDetail pdf");
	...
	private void createHeadings(PdfContentByte cb, float x, float y, String text) {
		System.out.println("inside createHeadings pdf");
